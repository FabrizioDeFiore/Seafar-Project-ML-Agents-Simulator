...
public class HandMeshMask : MonoBehaviour
{
    ...
    void AddPalmMesh(int knuckleVerts)
    {
        ...
        Vector3 middlePos = (referenceHand.Bones[10].Transform.position - referenceHand.Bones[9].Transform.position) + (referenceHand.Bones[13].Transform.position - referenceHand.Bones[12].Transform.position);
